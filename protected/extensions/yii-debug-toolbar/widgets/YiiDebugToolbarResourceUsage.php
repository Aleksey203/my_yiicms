...
/*            YiiDebug::t('Page Load Time')    =>  sprintf('%0.6F s.',$this->getLoadTime()),
            ...
            YiiDebug::t('Page Load Time')      =>  round($this->getLoadTime()*1000) . ' ms',
            YiiDebug::t('Elapsed Time')      =>  round($this->getRequestLoadTime()*1000) . ' ms',
            YiiDebug::t('Begin Server Time')      =>  $_SERVER['REQUEST_TIME'] . ' s',
            YiiDebug::t('Begin Time')      =>  $this->owner->owner->getStartTime() . ' s',
            YiiDebug::t('End Time')      =>  $this->owner->owner->getEndTime() . ' s',
